load data
 ...
 infile '/var/data/sbl/entrada/clcred-clie-20140519.txt'
 truncate
 into table EXTERNO.X_IB_PCL_LINEACREDITO
 (  NUMLINEA    position (001:008) char(8),
    ...
    IMPAJUST    position (176:190) char(15),
    FILLER      position (191:250) char(60),
